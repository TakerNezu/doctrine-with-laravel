...
use Doctrine\Migrations\Tools\Console\Command\StatusCommand as DoctrineThisCommand;use TakeruNezu\DoctrineWithLaravel\app\Console\Commands\Doctrine\DoctrineBaseCommand;

class StatusCommand extends DoctrineBaseCommand
{
